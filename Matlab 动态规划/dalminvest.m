...
uk,u0,xk,lk,Sk
 hold on;box on;
ylabel('Amounts invested in difference assets');xlabel('Mohth');
%plot(y(1,:),x(1,:),'b--','linewidth',2),
%plot(y(2,:),x(2,:),'r-','linewidth',2),
%legend('\xi_0=1 (bearish)','\xi_0=2 (bullish)',4);
%axis([0.12 1.6 3.6 5.4])
k=t(1:12)
plot(k,u0,'g-.','linewidth',2),
plot(k,uk(1,:),'b--','linewidth',2),
plot(k,uk(2,:),'m:','linewidth',2),
plot(k,uk(3,:),'r','linewidth',2),
