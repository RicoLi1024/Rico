...
uk,uk0,xk,lk,Sk,marketstate
 hold on;box on;
ylabel('Amounts invested in risk-free asset with differenct E[S_T]');xlabel('Mohth');
k=t(1:12)
plot(k,uk0(1,:),'k--.'),
plot(k,uk0(2,:),'g-','linewidth',3),
plot(k,uk0(3,:),'m:'),
plot(k,uk0(4,:),'r-.','linewidth',2),
plot(k,uk0(5,:),'b--','linewidth',2),
