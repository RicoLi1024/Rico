...
lk(k+1)=lk(k)*q+b;
Sk(k+1)=xk(k+1)-lk(k+1);
end
uk,uk0,xk,lk,Sk,marketstate
 hold on;box on;
ylabel('Wealth, liability and surplus process');xlabel('Mohth');
%plot(y(1,:),x(1,:),'b--','linewidth',2),
%plot(y(2,:),x(2,:),'r-','linewidth',2),
%legend('\xi_0=1 (bearish)','\xi_0=2 (bullish)',4);
%axis([0.12 1.6 3.6 5.4])

plot(t,xk,'b--','linewidth',2),
plot(t,lk,'m:','linewidth',2),
plot(t,Sk,'r','linewidth',2),
legend('Wealth process','Liability process','Surplus process', 2)
