...
uk,uk0,xk,lk,Sk,marketstate
 hold on;box on;
ylabel('Surplus processes with differenct expected terminal surplus levels');xlabel('Mohth');
plot(t,Sk(1,:),'k--.'),
plot(t,Sk(2,:),'g-','linewidth',3),
plot(t,Sk(3,:),'m:'),
plot(t,Sk(4,:),'r-.','linewidth',2),
plot(t,Sk(5,:),'b--','linewidth',2),
